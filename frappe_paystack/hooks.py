...
# app_include_icons = "frappe_paystack/public/icons.svg"
...
# jinja = {
# 	"methods": "frappe_paystack.utils.jinja_methods",
# 	"filters": "frappe_paystack.utils.jinja_filters"
# }
...
# before_uninstall = "frappe_paystack.uninstall.before_uninstall"
# after_uninstall = "frappe_paystack.uninstall.after_uninstall"
...
# before_app_install = "frappe_paystack.utils.before_app_install"
# after_app_install = "frappe_paystack.utils.after_app_install"
...
# before_app_uninstall = "frappe_paystack.utils.before_app_uninstall"
# after_app_uninstall = "frappe_paystack.utils.after_app_uninstall"
...
# 	}
    "Payment Request": {
        "after_insert": [
            "frappe_paystack.overides.payment_request.after_insert"
        ]
    }
}
...
# Request Events
# ----------------
# before_request = ["frappe_paystack.utils.before_request"]
# after_request = ["frappe_paystack.utils.after_request"]

# Job Events
# ----------
# before_job = ["frappe_paystack.utils.before_job"]
# after_job = ["frappe_paystack.utils.after_job"]
